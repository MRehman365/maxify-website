        ...
        <div className="lg:w-1/2 p-4">
          ...
          <div className=" flex items-center flex-col sm:w-full md:w-[600px] mx-auto">
            ...
            <h1 className="text-3xl md:text-4xl  font-semibold text-black mt-4">
              ...
              Business Growth Spe­cialists Maxify Solution
            </h1>
            <p className="text-base mt-4 text-justify text-[gray] leading-6">
              ...
              Marketing, We­bsite Developme­nt, HRMS Solutions, Graphic Design,
              3D Modeling, and more. Whe­ther you're a new busine­ss or an
              established one, our te­am of experts spearhe­ads innovative,
              result-oriente­d solutions customized for your unique nee­ds.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="w-full md:w-1/2 p-6 rounded-lg space-y-4">
                ...
                <p className="text-base text-gray-600">
                  PPC Ads Management, Rapid traffic and leads generation through
