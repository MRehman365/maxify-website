...
const Banking = () => {
  ...
  const services = {
    ...
    "iOS App Development": {
      ...
      description:
        "A specialist and easy-to-use website is essential for financial institutions to establish credibility and provide an excellent user experience. At Maxify Solutions, we provide specialized internet site advancement solutions for banks and economic firms in the banking and financial sector.",
      features: [
    ...
    "Cross-Platform App Development": {
      ...
      description:
        "As the banking and finance market moves towards digitalization, e-commerce platforms play an essential function in enabling online deals and financial product sales. Our e-commerce web development services are designed to support financial and banking services.",
      features: [
    ...
    "App Design and User Experience (UX)": {
      ...
      description:
        "Maxify Option provides customized software solutions for the banking and finance market, assisting organizations to enhance operational effectiveness and improve customer service.",
      features: [
    ...
    "App Testing and Quality Assurance": {
      ...
      description:
        "The banking and finance industry is undergoing a massive digital transformation. At Maxify Remedy, we offer end-to-end digital transformation solutions to help financial institutions adapt to the changing landscape.",
      features: [
  ...
  return (
    <div className="mt-[60px] font-pop">
      ...
      <div className="bg-[#0d0d1d] py-5">
        <div className="flex flex-col-reverse md:flex-row items-center p-3 bg-background min-h-max rounded-lg mx-auto sm:w-full md:w-[94%] lg:w-[80%]">
          ...
          <div className="md:w-1/2 p-4 md:px-8">
            ...
            <h3 className="sm:text-3xl md:text-4xl font-semibold text-[#1ad079] my-4">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center p-3 bg-background rounded-lg mx-auto sm:w-full md:w-[94%] lg:w-[80%]">
        <div className="md:w-1/2 p-4 md:px-8">
          <h3 className="sm:text-3xl md:text-5xl font-[400] text-[#000000] my-4">
          ...
          <p class="text-gray-500 text-justify text-sm leading-7 ">
            ...
            We Offer Customized Digital Remedies That Deal With The Certain
            Demands Of Banking And Financial Solutions.
          </p>
          <p class="text-gray-500 text-justify text-sm leading-7 ">
            <span className="text-black font-semibold">
              Cutting-Edge Modern Technology:
            </span>{" "}
            Utilizing The Latest Technologies, We Deliver Innovative Services
            That Assist Banks Stay Ahead Of The Contour In Banking And Financial
            Services.
          </p>
          <p class="text-gray-500 text-justify text-sm leading-7 mb-6">
            ...
            Our Emphasis Is On Constructing Lasting Collaborations By Supplying
            Value-Driven Services That Boost Development And Consumer
            Satisfaction In The Banking And Financial Industry.
          </p>
          ...
          <button
            ...
            className={`bg-[#f6f8fb] text-lg p-3 rounded-xl ${
              activeService === "Android App Development"
                ? "bg-white text-black font-[500] border-[2px] border-[#1ad079]"
                : "hover:bg-[#f6f8fb] hover:text-black font-[500]"
            }`}
          >
            DM For Banking
          </button>
          ...
          <button
            ...
            className={`bg-[#f6f8fb] text-lg p-3 rounded-xl ${
              activeService === "App Design and User Experience (UX)"
                ? "bg-white border-[2px] border-[#1ad079] text-black font-bold"
                : "hover:bg-[#f6f8fb] hover:text-black font-[500]"
            }`}
          >
            App for Banking
        ...
        <div className="flex flex-col gap-5 mt-7 md:flex-row dark:bg-card rounded-lg sm:p-2 md:p-6">
          ...
          <div className="md:w-1/2">
            ...
            <a href="https://wa.me/917428309119" target="blank">
              <button class="bg-[#1ad079] text-white text-sm hover:bg-primary/80 py-3 mt-4 px-4 rounded-lg">
                Start your business
              </button>
            </a>
          </div>
      ...
      <div className="flex flex-col md:flex-row items-center p-4 bg-background rounded-lg mx-auto sm:w-full md:w-[90%] lg:w-[80%]">
        ...
        <div className="md:w-1/2">
          ...
          <h3 className="sm:text-3xl md:text-5xl font-semibold text-[black] mt-4">
          ...
          <ul className="text-base leading-7 list-disc mt-3 text-[#6C6A72] text-justify px-6">
            <li>
              ...
              By leveraging the latest digital tools and technologies, we help
              financial institutions deliver exceptional customer experiences in
            ...
            <li>
              ...
              Our personalized software application solutions and digital tools
              help streamline operations and reduce costs within banking and
              financial services.
            </li>
            <li>
              <span className="text-black font-semibold">
              ...
              We ensure that all digital solutions comply with the latest
              regulatory needs and standards in banking and finance.
            </li>
            <li>
              <span className="text-black font-semibold">
                Enhanced Brand Exposure:{" "}
              </span>
              Our targeted digital marketing approaches improve online
              visibility, helping financial institutions attract and retain
              customers in the banking and financial industry.
            </li>
            <li>
              <span className="text-black font-semibold">
                Future-Ready Solutions{" "}
              </span>
              We provide innovative solutions that prepare banks and financial
              firms for the future, including digital banking, fintech
              integration, and more within banking and finance.
            </li>
          </ul>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className=" text-white p-6 rounded-lg">
            <h2 className="text-3xl md:text-4xl font-[500] mb-4 text-center">
              Why Buy <span className="font-bold">Digital Solutions</span> with
              Maxify Solution?
            </h2>
            <p className="mb-6 text-justify">
              Choosing Maxify Solution for your banking and financial services
              ...
              <li className="flex items-start">
                ...
                <div className="text-justify">
                  ...
                  <p className="text-gray-400">
                    With a team of seasoned professionals, we bring years of
                    experience and expertise to the table in banking and
                    financial services.
                  </p>
                </div>
              </li>
              <li className="flex items-start text-justify">
                ...
                <div>
                  <p className="text-gray-400">
                    ...
                    We stay ahead of the curve with innovative digital remedies
                    that drive growth and effectiveness in banking and financial
                    services.
                  </p>
                </div>
              </li>
      ...
      <section className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-[#eff3fe] rounded-lg shadow-lg p-6">
          ...
          <h2 className="text-blue-600 text-3xl font-semibold mb-2 uppercase  font-syne">
          ...
          <p className="text-gray-500 py-2 border-b-2">
            {" "}
            Align with your business objectives and deliver maximum value in the
            banking and finance sector.
          </p>

          <ul className="flex flex-wrap gap-6 mb-4 mt-4">
            <li className="flex items-center">
              <FaCheckCircle className="mr-2  text-[#1351d8]" /> Collaboration
              Tools
            </li>
            <li className="flex items-center">
        ...
        <div className="bg-[#eff3fe] rounded-lg shadow-lg p-6">
          ...
          <h2 className="text-[#1351d8] text-3xl font-semibold mb-2 uppercase  font-syne">
            Competitive Pricing
          </h2>
          ...
          <p className="text-gray-500 py-2 border-b-2">
            {" "}
            We offer affordable prices without compromising on the quality of
        ...
        <div className="relative md:w-1/2 py-6  sm:mt-6 md:mt-0 sm:px-4 md:px-10 lg:px-[5%]">
          <h2 className="sm:text-2xl md:text-4xl font-[400] text-center md:text-left">
            ...
            <span className="font-bold">
              Your Financial and Finance Procedures
            </span>{" "}
            with Maxify Solutions
          </h2>
          <p className="text-justify text-gray-300 mt-6">
            At Maxify Solution, we recognize that the banking and finance field
            is swiftly advancing, and staying ahead requires innovation,
            dexterity, and know-how. Whether you need a robust digital
            advertising strategy, a safe and user-friendly website, or
            custom-made software solutions for your banks, we have you covered
            in banking and financial services in India.
          </p>
          <div className="flex  items-center mt-2">
            <Link to="/about">
              <button
      ...
      <section className="max-w-7xl mx-auto py-12 px-4 grid grid-cols-1 md:grid-cols-2 items-center gap-8">
        ...
        <div className="w-full">
          ...
          <p className="text-lg text-gray-600 mb-6 leading-7 text-justify">
            To review your needs and discover exactly how{" "}
            <strong>Maxify Option</strong> can aid you navigate the digital
            transformation journey in the{" "}
