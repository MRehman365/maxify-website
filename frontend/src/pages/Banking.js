  ...
  return (
    <div className="mt-[70px]">
      <div className="bg-[#0d0d1d] py-5">
        <div className="flex flex-col-reverse md:flex-row items-center p-3 bg-background min-h-max rounded-lg mx-auto sm:w-full md:w-[94%] lg:w-[80%]">
          ...
          <div className="md:w-1/2 p-4 md:px-8">
            ...
            <h1 className="sm:text-3xl md:text-5xl font-semibold text-[#1ad079] my-4">
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2">
        <button
          ...
          className={`bg-[#f6f8fb] text-lg p-3 rounded-xl ${
            activeService === 'Android App Development' ? 'bg-white text-black font-bold border-[2px] border-[#1ad079]' : 'hover:bg-[#f6f8fb] hover:text-black font-bold'
          }`}
        >
          DM For Banking
        </button>
        <button
          ...
          className={`bg-[#f6f8fb] text-lg p-3 rounded-xl ${
            activeService === 'iOS App Development' ? 'bg-white text-black font-bold border-[2px] border-[#1ad079]' : 'hover:bg-[#f6f8fb] hover:text-black font-bold'
          }`}
        >
          www. for Banking
        </button>
        <button
          ...
          className={`bg-[#f6f8fb] text-lg p-3 rounded-xl ${
            activeService === 'Cross-Platform App Development' ? 'bg-white text-black font-bold border-[2px] border-[#1ad079]' : 'hover:bg-[#f6f8fb] hover:text-black font-bold'
          }`}
        >
        ...
        <button
          ...
          className={`bg-[#f6f8fb] text-lg p-3 rounded-xl ${
            activeService === 'App Design and User Experience (UX)' ? 'bg-white border-[2px] border-[#1ad079] text-black font-bold' : 'hover:bg-[#f6f8fb] hover:text-black font-bold'
          }`}
        >
          App for Banking
        </button>
        <button
          ...
          className={`bg-[#f6f8fb] p-3 rounded-xl ${
            activeService === 'App Testing and Quality Assurance' ? 'bg-white text-black font-bold border-[2px] border-[#1ad079]' : 'hover:bg-[#f6f8fb] hover:text-black font-bold'
          }`}
        >
          Digi Makeover
        </button>
      ...
      <div className="flex flex-col gap-5 mt-7 md:flex-row dark:bg-card rounded-lg sm:p-2 md:p-6">
        ...
        <div className="md:w-1/2">
          ...
          <button class="bg-[#1ad079] text-white text-sm hover:bg-primary/80 py-3 mt-4 px-4 rounded-lg">Start your business</button>
        </div>
      </div>
    </div>
    {/* 5th section */}
    <div className="flex flex-col md:flex-row items-center p-4 bg-background rounded-lg mx-auto sm:w-full md:w-[90%] lg:w-[80%]">
        ...
        <div className="md:w-1/2">
          ...
          <ul className="text-base leading-7 list-disc mt-3 text-[#6C6A72] text-justify">
            <li>
    ...
    <section className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="bg-[#eff3fe] rounded-lg shadow-lg p-6">
        ...
        <h2 className="text-blue-600 text-3xl font-bold mb-2 uppercase">Client-Centric Method:</h2>
      ...
      <div className="bg-[#eff3fe] rounded-lg shadow-lg p-6">
        ...
        <h2 className="text-[#1351d8] text-3xl font-bold mb-2 uppercase">Competitive Pricing</h2>
