      ...
      <div className="w-full md:w-[90%] lg:w-[80%] mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <ul className="space-y-4 md:w-[80%]">
              <li>
            ...
            <Link className="mt-6 inline-block border border-black text-black hover:bg-black hover:text-white px-4 py-2 rounded-2xl transition-colors">
              Learn more
            </Link>
          </div>
