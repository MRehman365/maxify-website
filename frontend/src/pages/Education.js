...
const Education = () => {
  ...
  return (
    <div className="mt-[70px]">
      ...
      {/* slider */}
      <h2 className="w-full md:w-[90%] lg:w-[80%] mx-auto text-black text-3xl md:text-5xl font-bold text-center">
        Our Comprehensive Education And Learning Web Development Solutions
      </h2>
              ...
              <div className="flex flex-col md:flex-row mt-2 items-center">
                <div className="md:w-1/2 p-2 md:p-6 space-y-3 sm:min-h-[70vh] md:min-h-auto">
                  ...
                  <p className="text-gray-600 mb-4 text-justify text-sm md:text-base">
                    A well-designed website is necessary for any type of school
                    or online discovery system. At Maxify Service, we offer
                    custom education website development services that surpass
                    simply aesthetic appeal. We create sites that are
                    functional, engaging, and optimized for performance.
                  </p>
                  <ul className="list-disc list-inside text-gray-600 space-y-3 text-sm md:text-base text-justify">
                    <li>
                      <strong>Receptive and Mobile-Optimized Layouts:</strong>{" "}
                      Guarantee a seamless individual experience throughout all
                      gadgets—desktop computers, tablet computers, and
                      smartphones.
                    </li>
                    <li>
                      <strong> SEO-Friendly Framework:</strong> Our websites are
                      built following search engine optimization's finest
                      practices to aid you in placing greater on search engines
                      and attracting even more natural web traffic.
                    </li>
                    <li>
                      <strong>Interactive Understanding Qualities:</strong> We
                      integrate interactive components such as quizzes,
                      conversation online forums, and live courses to improve
            ...
            <SwiperSlide>
              <div className="flex flex-col md:flex-row mt-2 items-center">
                <div className="md:w-1/2 p-2 md:p-6 space-y-3 sm:min-h-[70vh] md:min-h-auto">
                  ...
                  <p className="text-gray-600 mb-4 text-justify text-sm md:text-base">
                    The need for Internet education has escalated, and having a
                    durable e-learning website development strategy is
                    important. We concentrate on producing e-learning platforms
                    that satisfy various instructional demands, from K-12
                    education to higher education and specialist development.
                  </p>
                  <ul className="list-disc list-inside text-gray-600 space-y-3 text-sm md:text-base text-justify">
                    <li>
                      <strong> Custom Understanding Paths:</strong> Create
                      personalized learning courses to satisfy different
                      learning designs and pacesD
                    </li>
                    <li>
                      <strong>Gamification Components:</strong> Involve pupils
                      via gamified learning experiences such as badges,
                      leaderboards, and benefitsD
                    </li>
                    <li>
                      <strong>Secure Repayment Portals: </strong> Execute
                      protected payment services for program enrollments,
                      registrations, and various other purchases.
                    </li>
                  </ul>
                  <div className="">
                    <div className="flex justify-center gap-2  items-center mt-2">
            ...
            <SwiperSlide>
              <div className="flex flex-col md:flex-row mt-2 items-center">
                <div className="md:w-1/2 p-2 md:p-6 space-y-3 sm:min-h-[70vh] md:min-h-auto">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-3 text-sm md:text-base text-justify">
                    <li>
                      <strong>Easily Accessible Style:</strong> Apply access
                      functions to satisfy students with various needs,
                      guaranteeing conformity with access standards such as WCAG
                    </li>
                    <li>
                    ...
                    <li>
                      <strong> Multi-Language Support: </strong> Assistance with
                      diverse trainee demographics by offering multi-language
              ...
              <div className="flex flex-col md:flex-row mt-2 items-center">
                <div className="md:w-1/2 p-2 md:p-6 space-y-3 sm:min-h-[70vh] md:min-h-auto">
                  ...
                  <p className="text-gray-600 mb-4 text-justify text-sm md:text-base">
                    ...
                    development solutions are customized to produce scalable and
                    interactive platforms that foster learning and cooperation.
                  </p>
                  <ul className="list-disc list-inside text-gray-600 space-y-3 text-sm md:text-base text-justify">
                    <li>
                      <strong> Online Classrooms:</strong> Construct interactive
                      digital classes with video conferencing, chat, and
                      partnership devices to replicate the in-person learning
                      experienceB
                    </li>
                    <li>
                      <strong>Program Management Solutions:</strong> Integrate
                      robust program management tools that permit teachers to
                      produce, handle, and update course content quicklyB
                    </li>
                    <li>
                      <strong> Data Analytics and Reporting: </strong> Use
                      sophisticated analytics to track trainee efficiency and
                      interaction, helping educators make data-driven choices.
                    </li>
                  </ul>
                  <div className="">
                    <div className="flex justify-center gap-2  items-center mt-2">
        ...
        before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-right-full before:hover:right-0 before:rounded-full  before:bg-white before:-z-10  before:aspect-square before:hover:scale-150 overflow-hidden before:hover:duration-700  hover:text-[blue]"
            ...
            <SwiperSlide>
              <div className="flex flex-col md:flex-row mt-2 items-center">
                <div className="md:w-1/2 p-2 md:p-6 space-y-3 sm:min-h-[70vh] md:min-h-auto">
                  <h2 className="text-2xl md:text-3xl font-semibold lg:w-full text-[#3343e0] mb-4 sm:text-center md:text-left">
                    Education Mobile Application <br />
                    Development
                  </h2>
                  <p className="text-gray-600 mb-4 text-justify text-sm md:text-base">
                    With the growing usage of smart devices, having a devoted
                    mobile app for your academic platform can significantly
                    improve involvement. We provide education mobile application
                    development services that create user-friendly and
                    feature-rich applications for trainees, teachers, and moms
                    and dads.
                  </p>
                  <ul className="list-disc list-inside text-gray-600 space-y-3 text-sm md:text-base text-justify">
                    <li>
                      <strong>Interactive Understanding Applications:</strong>{" "}
                      Create applications that supply a large range of learning
                      materials such as videos, tests, and interactive lessons9
                    </li>
                    <li>
                      <strong> Real-Time Alerts:</strong> Keep trainees and
                      parents educated with real-time updates on assignments,
                      qualities, and institution events9
                    </li>
                    <li>
                      <strong>Offline Accessibility: </strong> Make It Possible
                      for offline access to finding materials, ensuring pupils
          ...
          <div className="lg:w-1/2 mb-10 lg:mb-0">
            ...
            <ul className="list-disc pl-5 space-y-4 text-gray-500 md:text-xl text-justify px-6 md:px-10">
              <li>
                ...
                By developing interactive and interesting electronic systems, we
                assist educational institutions in providing exceptional
              ...
              <li>
                ...
                Our customized remedies streamline administrative processes,
                minimize hand-operated jobs, and boost general efficiency.
              </li>
              <li>
                <span className="font-semibold text-black">
                  Data Safety Security and Compliance:
                </span>{" "}
                We focus on information protection and ensure all services
              ...
              <li>
                ...
                With interactive and easy-to-use internet sites and apps,
                student involvement and retention rates are enhanced.
              </li>
              <li>
                <span className="font-semibold text-black">
                  Scalability and Future-Readiness:
                </span>{" "}
                Our services are scalable and designed to adjust to future
                technological innovations in the education field.
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="relative min-h-screen flex items-center overflow-hidden bg-[#ecf8ff] -z-20">
        <div className="relative w-full flex md:flex-row flex-col">
          <div className="w-full md:w-1/2 relative space-y-8">
            ...
            <div className="absolute rounded-lg -z-10 inset-0 bg-gradient-to-br from-purple-600 via-purple-500 to-blue-500 transform -skew-x-12 -left-1/4 w-[100%]" />
          </div>
          ...
          <div className="w-full md:w-1/2 space-y-4 text-left p-4">
            ...
            <p className="text-sm md:text-lg text-justify text-gray-500 leading-relaxed">
              ...
              development solutions that not only satisfy the existing demands
              of the industry but also prepare schools for future difficulties.
              Whether you are an institution seeking to boost your electronic
              visibility, a college aiming to provide online training courses,
              or an EdTech startup with a distinct idea, we have the expertise
            ...
            <p className="text-sm md:text-lg text-justify text-gray-500 leading-relaxed">
              Ready to transform your educational offerings with sophisticated
              digital options? Contact Maxify Solution today for more
              information regarding just how our education website development
              services can assist you in achieving your goals and staying ahead
              in the rapidly evolving education and learning market.
            </p>
          </div>
        </div>
      </div>
