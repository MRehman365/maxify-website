    ...
    <div className="mt-[70px]">
      <div className="flex flex-col md:flex-row md:space-x-4 mt-8 w-[100%] mx-auto md:w-[90%] lg:w-[90%]">
        ...
        <div className="w-full md:w-1/2 py-4 md:p-8 sm:px-3  mt-4">
          <p className="md:text-xl sm:text-center md:text-left text-[#f8b948] font-[700]">
            Real-estate Industries{" "}
          </p>
          <h1 className="md:text-4xl sm:text-3xl font-bold md:mt-4 mb-2 sm:text-center md:text-left">
      ...
      <div className="bg-realestate py-4">
        <div className="flex flex-col lg:flex-row md:space-x-4 w-[100%] mx-auto md:w-[90%] lg:w-[90%]">
          ...
          <div className="w-full lg:w-1/2 py-4 md:p-8 sm:px-3 space-y-4">
            <h1 className="sm:text-3xl md:text-5xl font-bold mt-4 mb-2 sm:text-center md:text-left">
    ...
    <div className="swiper-button-next-custom">
      ...
      <div className="flex flex-col md:flex-row md:space-x-4 mt-8 w-[100%] mx-auto md:w-[90%] lg:w-[90%]">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-around p-4 md:p-4 sm:px-3">
          ...
          <div>
            <button className="bg-gradient-to-l from-[#077EEC] to-[#BD21FC] text-white py-3 px-4 sm:mt-2 md:mt-0 text-sm md:text-base rounded-full hover:bg-[#2334DE] transition duration-300">
              MORE ABOUT US
            </button>
          </div>
        </div>
      ...
      <div className="bg-[#87beb2] rounded-lg px-4 md:w-[90%] mx-auto flex flex-col md:flex-row items-center">
        <div className="md:w-2/3 w-full mb-6 md:mb-0 md:pr-8">
          ...
          <form className="flex sm:w-[300px] md:w-[50%]">
            <input
              type="email"
